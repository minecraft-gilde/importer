...
public final class ConfigLoader {
    ...
    public static PluginSettings load(FileConfiguration config) {
        PluginSettings.ImportSettings importSettings = new PluginSettings.ImportSettings(
                ...
                Math.max(1L, config.getLong("import.interval-seconds", 14400L)),
                ...
                Math.max(0, config.getInt("import.retention.keep-runs", 1)),
                ...
                config.getBoolean("import.name-resolver.after-import-enabled", true),
                Math.max(1, config.getInt("import.name-resolver.after-import-max-per-run", 300)),
                config.getBoolean("import.name-resolver.maintenance-enabled", true),
                Math.max(1L, config.getLong("import.name-resolver.maintenance-interval-seconds", 14400L)),
                Math.max(1, config.getInt("import.name-resolver.maintenance-max-per-run", 500)),
